...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'kannasay ?(.*)', fromMe: true, desc: Lang.ANIME_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by: Ask Your Mom', quoted: message.data })
    ...
    Asena.addCommand({ pattern: 'kannasay ?(.*)', fromMe: false, desc: Lang.ANIME_DESC }, (async (message, match) => {
