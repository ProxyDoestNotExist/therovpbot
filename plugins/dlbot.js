...
const IG_DESC = "Uploads Photos/Videos from Instagram"
const NEED_WORD = "You must enter a link"
const FBDESC = "Uploads Video from Facebook"
const LOADING = "Videos Loading..."
const NOT_FOUNDFB = "Video Not Found"
const CAPTION = "Disclosure"

Asena.addCommand({ pattern: 'instadl ?(.*)', fromMe: false, desc: IG_DESC}, async (message, match) => {
...
Asena.addCommand({ pattern: 'fbdl ?(.*)', fromMe: false, desc: FBDESC }, async (message, match) => {
